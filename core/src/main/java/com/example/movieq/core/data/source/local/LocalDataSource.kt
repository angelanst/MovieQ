package com.example.movieq.core.data.source.local

import com.example.movieq.core.data.source.local.entity.MovieEntity
import com.example.movieq.core.data.source.local.room.MovieDao
