package com.example.movieq.core.data

import com.example.movieq.core.data.source.local.LocalDataSource
import com.example.movieq.core.data.source.remote.RemoteDataSource
...
import com.example.movieq.core.utils.AppExecutors
import com.example.movieq.core.utils.DataMapper
...
class MovieRepository(
    ...
    override fun getAllMovie(): Flow<Resource<List<Movie>>> =
        object : com.example.movieq.core.data.NetworkBoundResource<List<Movie>, List<MovieResponse>>() {
